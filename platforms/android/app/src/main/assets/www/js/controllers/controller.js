...
mainApp.controller('answerQuestController', function($scope,$rootScope,$http,$localStorage,sharedProperties,$routeParams) {
	...
	$scope.submitAnswer = function(){
		...
		$http.post(apiUrl+'answer-question', data).then(function successCallback(response){
			...
			if(response.data.status == 'success')
			{
				$rootScope.showAlertWithShareBtn('Success', "Your connection will be thankful you've shared your input.",'OK', 'I just said ' + data.answer + ' on Decidable to the question "' + $scope.question.question + '". Share your opinion too!');
